 ...
 */
$config['join']['users']  = 'pgrupPengId';
$config['join']['groups'] = 'pgrupGrupId';
...
$config['admin_email']                = "tugashendraa1@gmail.com";
$config['default_group']              = 'Pengguna';
$config['admin_group']                = 'Admin';
$config['identity']                   = 'pengEmail';
 ...
 */
// $config['use_ci_email'] = TRUE; // Send Email using the builtin CI email class, if TRUE it will return the code and the identity
$config['email_config'] = [
	'mailtype' => 'html',
	'mailtype'  => 'html',
	'starttls'  => true,
	...
	'SMTPSecure' => 'tls',
	'smtp_port' => 465,
	'smtp_user' => 'tugashendraa1@gmail.com', // actual values different
	'smtp_pass' => 'nimda.321',
	'charset' => 'utf-8',
	'newline' => "\r\n",
	'wordwrap' => TRUE
