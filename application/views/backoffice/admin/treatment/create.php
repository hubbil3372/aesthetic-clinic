            ...
            <div class="card card-info card-outline">
                ...
                <div class="card-body">
                    <form class="align-self-center" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input class="form-control <?= form_error('treatmentNama') ? 'is-invalid' : null; ?>" id="treatmentNama" name="treatmentNama" type="text" value="<?= set_value('treatmentNama'); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input class="form-control <?= form_error('treatmentHarga') ? 'is-invalid' : null; ?>" id="treatmentHarga" name="treatmentHarga" type="text" pattern="[0-9]+" value="<?= set_value('treatmentHarga'); ?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input class="form-control <?= form_error('treatmentDiskon') ? 'is-invalid' : null; ?>" id="treatmentDiskon" name="treatmentDiskon" type="text" pattern="[0-9]+" value="<?= set_value('treatmentDiskon'); ?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <select class="form-control <?= form_error('treatmentStatus') ? 'is-invalid' : null; ?>" id="treatmentStatus" name="treatmentStatus">
                                        ...
                                        <option value="1" <?= set_value('treatmentStatus') == '1' ? 'selected' : null; ?>>Aktif</option>
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <div class="<?= form_error('treatmentFoto') ? 'is-invalid' : null; ?>">
                                        <input class="form-control dropify <?= form_error('treatmentFoto') ? 'is-invalid' : null; ?>" data-height="80" id="treatmentFoto" name="treatmentFoto" type="file">
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-12">
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control <?= form_error('treatmentDeskripsi') ? 'is-invalid' : null; ?>" id="treatmentDeskripsi" name="treatmentDeskripsi" rows="5"><?= set_value('treatmentDeskripsi'); ?></textarea>
                                    <div class="invalid-feedback">
                        ...
                        <button class="btn waitme btn-info text-white px-5" type="submit">Simpan</button>
                    </form>
                </div>
            </div>
        </div>
