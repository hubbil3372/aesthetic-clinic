			...
			<div class="card card-info card-outline">
				<div class="card-header d-flex justify-content-between align-items-center w-100">
					...
					<?php if ($this->akses->access_rights($menu_id, 'grupMenuTambah')) : ?>
						<a class="btn btn-info text-white waitme" href="<?= site_url(); ?>backoffice/grup/tambah">Tambah Grup</a>
					<?php endif; ?>
				</div>
				<div class="card-body">
...
<script>
	...
	$(document).ready(function() {
		table = $('#table').DataTable({
			...
			"order": [],
			"ajax": {
				"url": "<?= site_url("backoffice/admin/grup/get_json?tautan={$this->uri->segment(2)}") ?>",
				"type": "POST"
			},
			"columnDefs": [{
				"targets": [0, -1],
