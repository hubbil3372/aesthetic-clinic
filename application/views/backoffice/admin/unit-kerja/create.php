            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-4">
                  ...
                  <input class="form-control <?= form_error('ukNama') ? 'is-invalid' : null; ?>" id="ukNama" name="ukNama" type="text" value="<?= set_value('ukNama'); ?>">
              ...
              <div class="col-md-12">
                <div class="mb-4">
                  ...
                  <input class="form-control <?= form_error('ukDeskripsi') ? 'is-invalid' : null; ?>" id="ukDeskripsi" name="ukDeskripsi" type="text" value="<?= set_value('ukDeskripsi'); ?>">
                  <div class="invalid-feedback">
