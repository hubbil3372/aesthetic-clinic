            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-4">
                  ...
                  <input class="form-control <?= form_error('grupNama') ? 'is-invalid' : null; ?>" id="grupNama" name="grupNama" type="text" value="<?= $this->input->post('grupNama') ?? $group->grupNama; ?>">
              ...
              <div class="col-md-12">
                <div class="mb-4">
                  ...
                  <input class="form-control <?= form_error('grupDeskripsi') ? 'is-invalid' : null; ?>" id="grupDeskripsi" name="grupDeskripsi" type="text" value="<?= $this->input->post('grupDeksripsi') ?? $group->grupDeskripsi; ?>">
                  <div class="invalid-feedback">
