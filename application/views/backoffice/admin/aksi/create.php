            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-4">
                  ...
                  <input class="form-control <?= form_error('aksiLabel') ? 'is-invalid' : null; ?>" id="aksiLabel" name="aksiLabel" type="text" value="<?= set_value('aksiLabel'); ?>">
              ...
              <div class="col-md-12">
                <div class="mb-4">
                  ...
                  <input class="form-control <?= form_error('aksiTautan') ? 'is-invalid' : null; ?>" id="aksiTautan" name="aksiTautan" type="text" value="<?= set_value('aksiTautan'); ?>">
                  <div class="invalid-feedback">
