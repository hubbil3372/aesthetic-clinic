            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-4">
                  ...
                  <input class="form-control <?= form_error('voucherNama') ? 'is-invalid' : null; ?>" id="voucherNama" name="voucherNama" type="text" value="<?= set_value('voucherNama'); ?>">
              ...
              <div class="col-md-12">
                <div class="mb-4">
                  ...
                  <input class="form-control <?= form_error('voucherKode') ? 'is-invalid' : null; ?>" id="voucherKode" name="voucherKode" type="text" value="<?= set_value('voucherKode'); ?>">
                  <div class="invalid-feedback">
              ...
              <div class="col-md-12">
                <div class="mb-4">
                  <label class="form-label" for="voucherPotongan">Potongan (Rp)</label>
                  <input class="form-control <?= form_error('voucherPotongan') ? 'is-invalid' : null; ?>" id="voucherPotongan" name="voucherPotongan" type="text" value="<?= set_value('voucherPotongan'); ?>">
                  <div class="invalid-feedback">
              ...
              <div class="col-md-12">
                <div class="mb-4">
                  ...
                  <div class="form-check <?= form_error('voucherStatus') ? 'is-invalid' : null; ?>">
                    <input class="form-check-input" type="radio" name="voucherStatus" id="voucherStatus1" value="1" checked>
                    <label class="form-check-label" for="voucherStatus1">
                      Aktif
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="voucherStatus" id="voucherStatus2" value="0">
