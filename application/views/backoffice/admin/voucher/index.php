			...
			<div class="card">
				<div class="card-header d-flex justify-content-between align-items-center w-100">
					...
					<?php if ($this->akses->access_rights($menu_id, 'grupMenuTambah')) : ?>
						<a class="btn btn-success waitme" href="<?= site_url(); ?>backoffice/voucher/tambah">Tambah Voucher</a>
					<?php endif; ?>
				</div>
				<div class="card-body">
...
<script>
	...
	$(document).ready(function() {
		table = $('#table').DataTable({
			...
			"order": [],
			"ajax": {
				"url": "<?= site_url("backoffice/admin/voucher/get_json?tautan={$this->uri->segment(2)}") ?>",
				"type": "POST"
			},
			"columnDefs": [{
				"targets": [0],
