            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="mb-4">
                  ...
                  <select class="form-select <?= form_error('produkKategoriId') ? 'is-invalid' : null; ?>" id="produkKategoriId" name="produkKategoriId">
                    ...
                    <?php foreach ($kategori as $key => $v) { ?>
                      <option value="<?= $v->kategoriId ?>" <?= set_value('produkKategoriId') == $v->kategoriId ? 'selected' : null ?>><?= $v->kategoriNama ?></option>
                    <?php } ?>
                  </select>
                  <div class="invalid-feedback">
                ...
                <div class="mb-4">
                  ...
                  <textarea class="form-control <?= form_error('produkDeskripsi') ? 'is-invalid' : null; ?>" id="produkDeskripsi" name="produkDeskripsi" rows="7"><?= set_value('produkDeskripsi'); ?></textarea>
                  <div class="invalid-feedback">
                ...
                <div class="mb-4">
                  ...
                  <input class="form-control <?= form_error('produkHarga') ? 'is-invalid' : null; ?>" id="produkHarga" name="produkHarga" type="number" value="<?= set_value('produkHarga'); ?>">
                  <div class="invalid-feedback">
                ...
                <div class="mb-4">
                  ...
                  <input class="form-control <?= form_error('produkDiskon') ? 'is-invalid' : null; ?>" id="produkDiskon" name="produkDiskon" type="number" value="<?= set_value('produkDiskon'); ?>">
                  <div class="invalid-feedback">
              ...
              <div class="col-md-6">
                <div class="mb-4">
                  ...
                  <input class="form-control <?= form_error('produkStok') ? 'is-invalid' : null; ?>" id="produkStok" name="produkStok" type="number" value="<?= set_value('produkStok'); ?>">
                  <div class="invalid-feedback">
                ...
                <div class="mb-4">
                  ...
                  <input class="form-control <?= form_error('produkBerat') ? 'is-invalid' : null; ?>" id="produkBerat" name="produkBerat" type="number" value="<?= set_value('produkBerat'); ?>">
                  <div class="invalid-feedback">
                ...
                <div class="mb-4">
                  ...
                  <div class="form-check <?= form_error('produkStatus') ? 'is-invalid' : null; ?>">
                    <input class="form-check-input" type="radio" name="produkStatus" id="produkStatus1" value="1" checked>
                    <label class="form-check-label" for="produkStatus1">
                      Aktif
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="produkStatus" id="produkStatus2" value="0">
